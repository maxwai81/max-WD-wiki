...
Read this **before** drilling into folders. Links use vault-root paths (`[[wiki/...]]`, `[[raw/...]]`).

## Overview & meta

| Page | Summary |
|------|---------|
| [[wiki/overview]] | Vault purpose, HK Workday benefits scope, ingestion status, known documentation tensions |
| [[CLAUDE]] | Agent schema (project root) |

## Sources (`wiki/sources/*`) — one digest per `raw` clip
...
| [[wiki/sources/Business Travel Medical and Security]] | ISOS + Chubb duty of care, high-risk routing, Cigna→Chubb claims cutover |
| [[wiki/sources/Business Travel Accident & Business Travel Medical]] | Chubb Schedule of Benefits (ADD N18767041, eff. 1/1/26): USD caps, baggage, Israel carve-out |
...
| [[wiki/sources/TribeGO App User Guide (Workday Hong Kong)]] | Flex wallets HKD 10–15k, category rules + exclusions, TribeGO flows (Feb26–Jan27) |
| [[wiki/sources/Financial Investments]] | ESPP vs MPF vs voluntary pension vs rent scheme compare table |
| [[wiki/sources/Financial Wellbeing Support]] | Northstar access, HK tax note, bereavement continuation |
| [[wiki/sources/For When Life Happens]] | Narrative hub routing to leave, EAP, Maven, Northstar |
| [[wiki/sources/Health Insurance 1]] | AIA group medical highlights + fertility/Maven wallet ambiguity |
| [[wiki/sources/Here to Support Your Health]] | Short Maven article; family/menopause framing |
| [[wiki/sources/House Rent Reimbursement]] | HK rent scheme; PwC March filings; leaver timing |
| [[wiki/sources/Leave Entitlement]] | Master leave table; **PLOA summary tension** noted |
| [[wiki/sources/Life Insurance]] | AIA life/LTD/CI stack; 4× salary structure; Apr Workday visibility nuance |
| [[wiki/sources/Mind Matters (EAP)]] | Optum EAP + WMHC logistics + limits |
| [[wiki/sources/Personal and Extended Leave of Absence]] | 90-day vs extended PLOA rules, equity & pay suspension |
| [[wiki/sources/Taking Time Off]] | High-level leave storytelling; extended leave prose vs formal policy |
...
| Page | Summary |
|------|---------|
| [[wiki/entities/Workday Benefits]] | Themed index of all HK benefits digests + concept entry points |
...
*None yet — ask the agent to draft comparisons (e.g., all leave types cheat sheet) when needed.*

## Raw quick map

Each **Sources** row points to a digest whose canonical input is a file in `raw/` — usually **`*.md`** (clipped portal pages) or **`*.pdf`** (schedules, brochures, claim kits, guides); the basename usually matches the digest title (e.g. [[raw/Health Insurance 1]], [[raw/AIA Health Insurance Coverage.pdf]] — odd filenames kept verbatim). **Do not edit `raw/` from the agent.**
